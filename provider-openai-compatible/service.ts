...
const result = await serve((settings, authority, budgets, schemas, clock, scope) => configure(settings, process.env['LLM_KEY'], authority, budgets, schemas, clock, scope), outcome => {
