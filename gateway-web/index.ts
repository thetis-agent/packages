...
export const stages = {};
export const settings = { messageBytes: 1048576, pending: 8, streams: 8, turnMs: 600000, headerBytes: 16384, pendingIdentity: 8, openingFrames: 256, statusMs: 4000, logRows: 120 };
