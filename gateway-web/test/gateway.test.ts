...
test("panel: the built-in sections are the same for everyone; a package's admin sections and verbs follow the role", async () => {
  ...
  assert.deepEqual(marketplaceUi?.commands, ["search", "show", "install", "remove", "delete", "update", "unfork", "publish-targets", "publish", "config-show", "config-list", "config-set", "config-unset", "fence-reload", "install-everyone", "install-for", "remove-for", "promote", "people"]);
