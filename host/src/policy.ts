...
//
// This is mechanism and would belong in @thetis/lib, except that it is a fact about the host process rather
// than about Thetis, and @thetis/host is where wiring and host facts live.
